namespace Unosquare.PiGpio.ManagedModel
{
    ...
    public partial class GpioPin
    {
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.I2CSDA,
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.I2CSCL,
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.SPICS,
            Name = "BCM 7 (CE1)",
        });
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.SPIMISO,
            Name = "BCM 9 (MISO)",
        });
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.SPICLK,
            Name = "BCM 11 (SCLCK)",
        });
        ...
        {
            Capabilities = PinCapabilities.GP | PinCapabilities.UARTRTS,
            Name = "BCM 17",
        });
