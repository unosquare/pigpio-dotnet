namespace Unosquare.PiGpio.NativeMethods.Interfaces
{
    ...
    public interface IIOService
    {
        ...
        ResultCode GpioSetMode(SystemGpio gpio, PigpioPinMode mode);
        ...
        PigpioPinMode GpioGetMode(SystemGpio gpio);
        ...
        ResultCode GpioSetPullUpDown(SystemGpio gpio, GpioPullMode pullMode);
        ...
        ResultCode GpioWrite(SystemGpio gpio, bool value);
        ...
        ResultCode GpioTrigger(UserGpio userGpio, uint pulseLength, bool value);
        ...
        ResultCode GpioWriteBits00To31Clear(BitMask bits);
        ...
        /// <param name="bits">a bit mask of GPIO to clear.</param>
        /// <returns>Returns 0 if OK.</returns>
        ResultCode GpioWriteBits32To53Clear(BitMask bits);
        ...
        /// <returns>Returns 0 if OK.</returns>
        ResultCode GpioWriteBits00To31Set(BitMask bits);
        ...
        /// <param name="bits">a bit mask of GPIO to set.</param>
        /// <returns>Returns 0 if OK.</returns>
        ResultCode GpioWriteBits32To53Set(BitMask bits);
        ...
        ResultCode GpioSetAlertFunc(UserGpio userGpio, PiGpioAlertDelegate callback);
        ...
        /// <returns>Returns 0 if OK, otherwise PI_BAD_USER_GPIO.</returns>
        ResultCode GpioSetAlertFuncEx(UserGpio userGpio, PiGpioAlertExDelegate callback, UIntPtr userData);
        ...
        ResultCode GpioSetWatchdog(UserGpio userGpio, uint timeoutMilliseconds);
        ...
        ResultCode GpioSetIsrFunc(SystemGpio gpio, EdgeDetection edge, int timeout, PiGpioIsrDelegate callback);
        ...
        /// <param name="userData">pointer to arbitrary user data.</param>
        /// <returns>Returns 0 if OK, otherwise PI_BAD_GPIO, PI_BAD_EDGE, or PI_BAD_ISR_INIT.</returns>
        ResultCode GpioSetIsrFuncEx(SystemGpio gpio, EdgeDetection edge, int timeout, PiGpioIsrExDelegate callback, UIntPtr userData);
        ...
        /// <returns>Returns 0 if OK.</returns>
        ResultCode GpioSetGetSamplesFunc(PiGpioGetSamplesDelegate callback, BitMask bits);
        ...
        /// <returns>Returns 0 if OK.</returns>
        ResultCode GpioSetGetSamplesFuncEx(PiGpioGetSamplesExDelegate callback, BitMask bits, UIntPtr userData);
        ...
        ResultCode GpioGlitchFilter(UserGpio userGpio, uint steadyMicroseconds);
        ...
        /// <returns>Returns 0 if OK, otherwise PI_BAD_USER_GPIO, or PI_BAD_FILTER.</returns>
        ResultCode GpioNoiseFilter(UserGpio userGpio, uint steadyMicroseconds, uint activeMicroseconds);
        ...
        GpioPadStrength GpioGetPad(GpioPadId pad);
        ...
        ResultCode GpioSetPad(GpioPadId pad, GpioPadStrength padStrength);
        ...
        int GpioReadUnmanaged(SystemGpio gpio);
        ...
        /// <param name="value">0-1.</param>
        /// <returns>Returns 0 if OK, otherwise PI_BAD_GPIO or PI_BAD_LEVEL.</returns>
        ResultCode GpioWriteUnmanaged(SystemGpio gpio, DigitalValue value);
        ...
        /// <param name="pad">0-2, the pad to get.</param>
        /// <returns>Returns the pad drive strength if OK, otherwise PI_BAD_PAD.</returns>
        int GpioGetPadUnmanaged(GpioPadId pad);
        ...
        int GpioGetModeUnmanaged(SystemGpio gpio);
        ...
        /// <param name="value">0,1.</param>
        /// <returns>Returns 0 if OK, otherwise PI_BAD_USER_GPIO, PI_BAD_LEVEL, or PI_BAD_PULSELEN.</returns>
        ResultCode GpioTriggerUnmanaged(UserGpio userGpio, uint pulseLength, DigitalValue value);
