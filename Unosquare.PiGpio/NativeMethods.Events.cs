namespace Unosquare.PiGpio
{
    ...
    public static partial class NativeMethods
    {
        ...
        public static extern int EventMonitor(uint handle, uint bits);
        ...
        public static extern int EventSetFunc(uint @event, EventDelegate f);
        ...
        public static extern int EventSetFuncEx(uint @event, EventExDelegate f, IntPtr userData);
        ...
        /// with an event.
        /// </summary>
        /// <param name="event">0-31, the event</param>
        /// <returns>Returns 0 if OK, otherwise PI_BAD_EVENT_ID.</returns>
        [DllImport(Constants.PiGpioLibrary, EntryPoint = "eventTrigger")]
        public static extern int EventTrigger(uint @event);
    }
}
